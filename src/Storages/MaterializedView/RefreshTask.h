...
public:
    ...
    RefreshTask(StorageMaterializedView * view_, ContextPtr context, const ASTRefreshStrategy & strategy, bool attach, bool coordinated);
...
struct OwnedRefreshTask
{
    ...
    OwnedRefreshTask(RefreshTaskPtr p) : ptr(std::move(p)) {}
